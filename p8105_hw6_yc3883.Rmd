...
For each bootstrap sample, produce estimates of r^2 quantities. Plot the distribution of your estimates, and describe these in words.
...
For each bootstrap sample, produce estimates of log(β0∗β1) quantities. Plot the distribution of your estimates, and describe these in words.
