...
Fit the model. We have two possible models for candidates. Model\_1 uses
...
```
    ...
    ##   <chr>          <dbl>     <dbl>     <dbl>     <dbl>
    ## 1 (Intercept)  -5998.     107.       -56.3 0        
    ## 2 bhead          149.       3.89      38.3 2.46e-268
    ## 3 blength         82.3      2.30      35.8 1.69e-239
...
```
    ...
    ##   term        estimate std.error statistic  p.value
    ##   <chr>          <dbl>     <dbl>     <dbl>    <dbl>
    ## 1 (Intercept)  -5195.     120.       -43.3 0       
    ## 2 bhead          221.       3.74      59.0 0       
    ## 3 gaweeks         22.5      1.91      11.8 2.59e-31
...
The distribution of estimated r^2 has a mean of 0.9115249, which
represents a overrall strong association between “tmax” and “tmin”. The
standard deviation of the distribution is 0.0083679.
...
The distribution of estimated log(β0∗β1) has a mean of 2.0123558. The
standard deviation of the distribution is 0.0237067. This distribution
is may be more approach normal distribution compared with the estimated
r^2 distribution, which has a little bit shift to right.
