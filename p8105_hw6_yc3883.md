...
```
    ...
    ##   <chr>          <dbl>     <dbl>     <dbl>     <dbl>
    ## 1 (Intercept)  -5919.     106.       -55.6 0        
    ## 2 bhead          147.       3.88      37.9 1.98e-263
    ## 3 blength         82.2      2.28      36.0 1.71e-241
...
```
    ...
    ##   term        estimate std.error statistic     p.value
    ##   <chr>          <dbl>     <dbl>     <dbl>       <dbl>
    ## 1 (Intercept)  -5134.     120.       -42.9 Inf.  e-324
    ## 2 bhead          217.       3.73      58.1   0        
    ## 3 gaweeks         24.3      1.91      12.8   1.65e- 36
...
The distribution of estimated r^2 has a mean of 0.9113274, which
represents a overrall strong association between “tmax” and “tmin”. The
standard deviation of the distribution is 0.0085484.
...
The distribution of estimated log(β0∗β1) has a mean of 2.0133654. The
standard deviation of the distribution is 0.0241431. This distribution
